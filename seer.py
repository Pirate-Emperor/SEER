...
class SEER(object):
    ...
    def parse(self, image_path: str):
        ...
        # formating output
        return_list = [{'from': 'seer', 'shape': {'x':coord[0], 'y':coord[1], 'width':coord[2], 'height':coord[3]},
        ...
        return_list.extend(
            [{'from': 'seer', 'shape': {'x':coord[0], 'y':coord[1], 'width':coord[2], 'height':coord[3]},
...
print(f'Time taken for SEER on {device}:', time.time() - s)
